...
-- ⚠️  Certifique-se de que o Row Level Security (RLS) está habilitado no projeto

-- =====================================================
-- 1. LIMPEZA E PREPARAÇÃO
-- =====================================================

-- Apaga tabelas existentes (se houver) para uma reinicialização limpa
...
-- =====================================================
-- 13. CRIAÇÃO DE USUÁRIO ADMINISTRADOR INICIAL
-- =====================================================

-- ⚠️  IMPORTANTE: Execute este comando após criar o usuário no Supabase Auth
-- ⚠️  Substitua 'SEU_UUID_DO_USUARIO' pelo UUID real do usuário criado

/*
-- Exemplo de como criar um usuário administrador:
INSERT INTO z_profiles (id, name, email, profile, status) VALUES (
    'SEU_UUID_DO_USUARIO', -- Substitua pelo UUID real
    'Administrador',
    'admin@exemplo.com',
    'Administrador',
    'Ativo'
...
4. 🔗 Atualize o UUID do administrador no comentário acima
5. 🧪 Teste as conexões e funcionalidades
6. 📊 Configure backups e monitoramento
